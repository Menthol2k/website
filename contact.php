...
?>
        ...
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2483.748674237327!2d-0.12700324844625438!3d51.499479379533994!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x487604c40c8d9b99%3A0x7797a8ef74e1f7c!2sPalace+of+Westminster!5e0!3m2!1sen!2suk!4v1539978805296" width="100%" height="600" frameborder="0" style="border:0" allowfullscreen></iframe>
		<!-- END map -->
				...
				<form action="contact.php#formular" method="post">
					<div class="row">
						<div class="col-md-6 col-md-push-6">
							<h3 class="section-title">LASĂ-NE UN GÂND</h3>
							<p>Știm că iubești Londra. Hai să vorbim!</p>
							<ul class="contact-info">
								<li><i class="icon-location-pin"></i>Strada</li>
								<li><i class="icon-phone2"></i><a href="tel:+ 112" </a>+ 112</li>
								<li><i class="icon-mail"></i><a href="mailto:user@mail.com">user@mail.com</a></li>
								<li><i class="icon-globe2"></i><a href="http://127.0.0.1/locatie">http://127.0.0.1/locatie</a></li>
							</ul>
						</div>
